@echo off
:: Generated on 2026-01-19 05:42:33 GMT
...
:START_PROCESS
title 26200.7623_arm64_zh-cn_multi_48d68897 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=48d68897-f53e-4f7e-9dd0-d25baecb5cc2&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=48d68897-f53e-4f7e-9dd0-d25baecb5cc2&pack=zh-cn&edition=professional%%3Bcorecountryspecific%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
